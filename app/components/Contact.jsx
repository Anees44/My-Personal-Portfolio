...
//         {
//           from_name: form.name,
//           to_name: "Anees Ur Rehman",
//           from_email: form.email,
//           to_email: "itxanees44@gmail.com",
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_x3vdejc", // ✅ your EmailJS service ID
        "template_qybq7gr", // ✅ your EmailJS template ID
        {
          from_name: form.name,
          to_name: "Anees Ur Rehman",
          from_email: form.email,
      ...
      .then(() => {
        ...
        if (formRef.current) {
          formRef.current.reset(); // optional: resets the actual form UI
        }
      })
      .catch((error) => {
